...
class VerticalScrolledFrame:
    ...
    note that a widget laid out in this frame will have a self.master 3 layers deep,
...
def uploadProtocol(frameDict, entryDict, contrastDict, frequencyDict, imageBarDict, metadataBox, statusLabel, killFlag, uploadButton, presetVar, presetList):
    ...
    def exportFiles(fileString, mountDir):
        ...
        for image in imageList:
            ...
            if image == 'Solid.png':
                imageFile = drawImage('Horizontal_Stripes', frequency, lowInt, highInt)
            elif image == 'Vertical_Stripes.png':
                imageFile = drawImage('Vertical_Stripes', frequency, lowInt, highInt)
